...
print(total_value_loans)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amt = total_value_loans / number_of_loans
...
current_future_value = loan.get("future_value")
current_remaining_months = loan.get("remaining_months")

print(current_future_value)
print(current_remaining_months)
...
for inexpensive in loans:
    if inexpensive["loan_price"] <= 500:
        inexpensive_loans.append(inexpensive)
